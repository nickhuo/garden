...
related: ["[[GEPA]]", "[[DSPy]]", "[[Compound AI System]]", "[[Pareto-based Candidate Selection]]", "[[In-Context Learning]]", "[[Few-Shot Drift]]", "[[GRPO]]"]
...
| **MIPROv2** (Opsahl-Ong 2024) | joint instruction + few-shot, Bayesian opt | — |
| **[[GEPA]]** (Agrawal 2026) | reflective evolutionary mutation | [[Pareto-based Candidate Selection]] |

## Key shifts GEPA documents

1. **Instruction-only can beat joint instruction+few-shot.** Prior work (MIPROv2, Wan et al. 2024) found few-shot demonstrations usually win. GEPA reverses this — attributed to better instruction-following / self-reflection in modern LLMs, plus reflective evolution producing rich **declarative** instructions rather than quasi-exemplars.
