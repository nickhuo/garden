...
## [2026-05-23] refactor | PR review — dropped 3 pages
- **Trigger:** Nick's PR #1 review comments ("drop this source") on the online-eval autoresearch branch.
- **Deleted:** `wiki/sources/2024-10-14 - Zhuge et al - Agent-as-a-Judge.md`, `wiki/sources/2026 - Raindrop - Agent Self-Diagnostics.md`, and (per Nick's follow-up) the dependent concept `wiki/concepts/Agent-as-a-Judge.md`.
- **Cleanup:** removed all cross-references; "Agent-as-a-Judge" judging is now described inline as "step-level agentic judges" in [[Online LLM-as-Judge]], [[Continuous Evaluation]], [[Online Evaluation Bottlenecks]], [[Online Evaluation]], [[LLM-as-Judge Evaluation]], and the synthesis; Raindrop self-diagnostics content removed from [[Raindrop]] and [[Specialized Eval Classifiers]]. Counts/indices updated.
- **Rationale (Nick):** the two sources hadn't made a significant contribution; the concept depended solely on the dropped Zhuge source.
...
- **Pages created (7):** entity [[Raindrop]]; concepts [[Binary Evaluation vs Scoring]], [[Specialized Eval Classifiers]]; sources [[2026 - Raindrop - Thoughts on Evals]], `2026 - Raindrop - Agent Self-Diagnostics` (later dropped in review), [[2026-01-15 - Husain Shankar - LLM Evals FAQ]], [[2025-04-20 - Tripathi et al - Pairwise or Pointwise]].
...
- **Pages created (12):** sources [[2025-03-20 - Yehudai et al - Survey on Evaluation of LLM-based Agents]], [[2025-07-29 - Mohammadi et al - Evaluation and Benchmarking of LLM Agents]], `2024-10-14 - Zhuge et al - Agent-as-a-Judge` (later dropped in review), [[2025-03-28 - Guan et al - Multi-Turn Conversational Agent Evaluation Survey]], [[2025 - LangChain - LLM Observability and Monitoring]], [[2025 - Goodeye Labs - LLM Evaluation 2025 Review]]; concepts [[Continuous Evaluation]], [[Online LLM-as-Judge]], `Agent-as-a-Judge` (later dropped in review), [[Offline-Online Evaluation Gap]], [[Online Evaluation Bottlenecks]]; synthesis [[Research - Online Evaluation in Production]].
