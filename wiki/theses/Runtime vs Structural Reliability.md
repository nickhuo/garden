...
- **Harness > model is now the public framing.** [[2026-05-14 - Anthropic - Claude Code in Large Codebases]] says it directly: "the harness determines performance more than the model." Five structural extension points ([[brain/CLAUDE]], hooks, [[Agent Skills|skills]], plugins, [[MCP]]) plus LSP and subagents are *all* structural. None of them are runtime checks.
